...
const Skills = () => {
    return (
        <div className="skills-container">
            ...
            <div className='desig'>
                    <div className='title-skill-design'>
                        <div className='tit'>
                    ...
                    <div className='desig-container-skills'>
                        <h2>Tooling</h2>
                        <div className="tools">
                        <div className="tool">
                            <img src="https://api.iconify.design/devicon:figma.svg" alt="JavaScript" />
                            <p>Figma</p>
                        </div>
                        <div className="tool">
                            <img src="https://api.iconify.design/devicon:photoshop.svg" alt="React" />
                            <p>Photoshop</p>
                        </div>
                        <div className="tool">
                            <img src="https://api.iconify.design/wpf:create-new.svg" alt="React" />
                            <p>Paper</p>
                        </div>
                        </div>
                    </div>
